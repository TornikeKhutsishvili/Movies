...
export class EditProfileComponent implements OnInit {
  ...
  // დროებითი ცვლადები ngModel-სთვის
  usernameValue = '';
  passwordValue = '';
  ...
  save(): void {
    ...
    // აქ ვაწარმოებთ ცვლილებებს Signal-ებზეც და შენახვაზეც
...
//   // Signal-ები შენახვისთვის და სტატუსებისთვის
//   username = signal('');
//   password = signal('');
//   confirmPassword = signal('');
//   email = signal('');
...
//   // დროებითი ვალები ngModel-ისთვის
//   usernameValue = '';
//   passwordValue = '';
//   confirmPasswordValue = '';
